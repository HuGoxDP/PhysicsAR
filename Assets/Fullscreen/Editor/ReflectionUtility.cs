...
namespace FullscreenEditor
{
    ...
    public static class ReflectionUtility
    {
        ...
        public static MethodInfo FindMethod(this Type type, string methodName, Type[] args = null,
        ...
        {
            return (T)obj.GetType().FindMethod(methodName, args.Select(a => a.GetType()).ToArray()).Invoke(obj, args);
        }
        ...
        {
            type.FindMethod(methodName, args.Select(a => a.GetType()).ToArray()).Invoke(null, args);
        }
        ...
        {
            obj.GetType().FindMethod(methodName, args.Select(a => a.GetType()).ToArray()).Invoke(obj, args);
        }
