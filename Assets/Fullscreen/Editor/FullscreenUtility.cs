...
namespace FullscreenEditor
{
    ...
    public static class FullscreenUtility
    {
        ...
        static FullscreenUtility()
        {
            ...
            EditorApplication.update += () =>
            {
                if (EditorApplication.timeSinceStartup - lastUpdate > 0.5f &&
                    FullscreenPreferences.RectSource.Value == RectSourceMode.AtMousePosition)
                {
        ...
        {
            get { return Application.platform == RuntimePlatform.LinuxEditor; }
        }
        ...
        private static Texture2D FindOrLoadTexture(string base64)
        {
            ...
            return found ? found : LoadTexture(base64);
        }
        ...
        public static ScriptableObject GetFocusedViewOrWindow()
        {
            ...
            return alone || leastSpecificView.IsOfType(Types.MainView) ? EditorWindow.focusedWindow : leastSpecificView;
        }
