    ...
    public class AnimationPreviewEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.BeginVertical(GUIStyles.HelpBoxStyle);
            {
                ...
                {
                    Application.OpenURL(
                        "https://assetstore.unity.com/packages/tools/animation/animation-preview-224321"
                    );
                }
            ...
            EditorGUILayout.BeginVertical();
            {
                ...
                {
                    GUI.backgroundColor = animatorManager.HasAnimator() && animatorManager.HasAnimatorController()
                        ? GUIStyles.DefaultBackgroundColor
                        : GUIStyles.ErrorBackgroundColor;
                    {
                        ...
                        {
                            EditorGUILayout.HelpBox(
                                "The animator must have a controller. Use a gameobject with an attached Animator and Controller.",
                                MessageType.Error
                            );
                        }
                    }
                    ...
                    {
                        EditorGUILayout.HelpBox(
                            "Quick solution to get a preview of all animations:\n1. Create > Animator Controller\n2. Drag all animations into the controller\n3. Add controller to your animator ",
                            MessageType.Info
                        );
                    }
                }
            ...
            switch (editorTarget.mode)
            {
                ...
                default:
                    throw new Exception("Unsupported mode: " + editorTarget.mode);
            }
            ...
            if (animatorChanged)
            {
                ...
                editorTarget.clipIndex = !animatorManager.HasAnimator() || !animatorManager.HasAnimatorController() ||
                                         animatorManager.GetAnimatorController().animationClips.Length == 0
                    ? -1
                    : 0;
