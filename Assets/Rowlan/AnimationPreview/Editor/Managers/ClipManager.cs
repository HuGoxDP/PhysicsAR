            ...
            EditorGUILayout.BeginVertical();
            {
                ...
                if (editor.GetAnimatorManager().HasAnimator() && editor.GetAnimatorManager().HasAnimatorController())
                {
                    ...
                    for (int i = 0; i < clips.Length; i++)
                    {
                        ...
                        GUI.backgroundColor = isCurrentClip
                            ? GUIStyles.SelectedClipBackgroundColor
                            : GUIStyles.DefaultBackgroundColor;
                        {
                            EditorGUILayout.BeginHorizontal();
                            {
                                ...
                                if (GUILayout.Button(
                                        EditorGUIUtility.IconContent("AnimationClip Icon", "Open Clip in Project"),
                                        GUIStyles.ToolbarButtonStyle
                                    ))
                                {
                                    OpenClip(i);
                                }
