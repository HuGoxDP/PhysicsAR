...
namespace Sirenix.OdinInspector.Modules.UnityMathematics.Editor
{
    ...
    public class DisableUnityMatrixDrawerAttributeDrawer : OdinAttributeDrawer<DisableUnityMatrixDrawerAttribute>
    {
        protected override void Initialize()
        {
            ...
            for (int i = 0; i < chain.Length; i++)
            {
                ...
                if (type.IsGenericType && type.GetGenericTypeDefinition() == typeof(UnityPropertyDrawer<,>) &&
    ...
    public class Bool2Drawer : OdinValueDrawer<bool2>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            {
                var showLabels = !this.isMatrixChild && SirenixEditorFields.ResponsiveVectorComponentFields &&
    ...
    public class Float2Drawer : OdinValueDrawer<float2>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            ...
            genericMenu.AddItem(
                ...
                Mathf.Approximately(vec.magnitude, 1f),
                () => NormalizeEntries(property)
            );
            genericMenu.AddItem(
                new GUIContent("Zero", "Set the vector to (0, 0)"),
                vec == Vector2.zero,
                () => SetVector(property, Vector2.zero)
            );
            genericMenu.AddItem(
                new GUIContent("One", "Set the vector to (1, 1)"),
                vec == Vector2.one,
                () => SetVector(property, Vector2.one)
            );
            genericMenu.AddSeparator("");
            genericMenu.AddItem(
                new GUIContent("Right", "Set the vector to (1, 0)"),
                vec == Vector2.right,
                () => SetVector(property, Vector2.right)
            );
            genericMenu.AddItem(
                new GUIContent("Left", "Set the vector to (-1, 0)"),
                vec == Vector2.left,
                () => SetVector(property, Vector2.left)
            );
            genericMenu.AddItem(
                new GUIContent("Up", "Set the vector to (0, 1)"),
                vec == Vector2.up,
                () => SetVector(property, Vector2.up)
            );
            genericMenu.AddItem(
                new GUIContent("Down", "Set the vector to (0, -1)"),
                vec == Vector2.down,
                () => SetVector(property, Vector2.down)
            );
        }
            ...
            property.Tree.DelayActionUntilRepaint(() =>
                {
                    for (int i = 0; i < property.ValueEntry.ValueCount; i++)
                    {
                        property.ValueEntry.WeakValues[i] =
                            math.normalizesafe((float2)property.ValueEntry.WeakValues[i]);
                    }
                }
            );
        }
    ...
    public class Float3Drawer : OdinValueDrawer<float3>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            ...
            genericMenu.AddItem(
                new GUIContent("Zero", "Set the vector to (0, 0, 0)"),
                vec == Vector3.zero,
                () => SetVector(property, Vector3.zero)
            );
            genericMenu.AddItem(
                new GUIContent("One", "Set the vector to (1, 1, 1)"),
                vec == Vector3.one,
                () => SetVector(property, Vector3.one)
            );
            genericMenu.AddSeparator("");
            genericMenu.AddItem(
                new GUIContent("Right", "Set the vector to (1, 0, 0)"),
                vec == Vector3.right,
                () => SetVector(property, Vector3.right)
            );
            genericMenu.AddItem(
                new GUIContent("Left", "Set the vector to (-1, 0, 0)"),
                vec == Vector3.left,
                () => SetVector(property, Vector3.left)
            );
            genericMenu.AddItem(
                new GUIContent("Up", "Set the vector to (0, 1, 0)"),
                vec == Vector3.up,
                () => SetVector(property, Vector3.up)
            );
            genericMenu.AddItem(
                new GUIContent("Down", "Set the vector to (0, -1, 0)"),
                vec == Vector3.down,
                () => SetVector(property, Vector3.down)
            );
            genericMenu.AddItem(
                new GUIContent("Forward", "Set the vector property to (0, 0, 1)"),
                vec == Vector3.forward,
                () => SetVector(property, Vector3.forward)
            );
            genericMenu.AddItem(
                new GUIContent("Back", "Set the vector property to (0, 0, -1)"),
                vec == Vector3.back,
            ...
            property.Tree.DelayActionUntilRepaint(() =>
                {
                    ...
                    {
                        property.ValueEntry.WeakValues[i] =
                            math.normalizesafe((float3)property.ValueEntry.WeakValues[i]);
                    }
                }
            );
        }
    ...
    public class Float4Drawer : OdinValueDrawer<float4>, IDefinesGenericMenuItems
    {
        ...
        public void PopulateGenericMenu(InspectorProperty property, GenericMenu genericMenu)
        {
            ...
            genericMenu.AddItem(
                new GUIContent("Zero", "Set the vector to (0, 0, 0, 0)"),
                vec == Vector4.zero,
                () => SetVector(property, Vector3.zero)
            );
            genericMenu.AddItem(
                new GUIContent("One", "Set the vector to (1, 1, 1, 1)"),
                vec == Vector4.one,
                () => SetVector(property, Vector4.one)
            );
            genericMenu.AddSeparator("");
            genericMenu.AddItem(
                new GUIContent("Right", "Set the vector to (1, 0, 0, 0)"),
                (Vector3)vec == Vector3.right,
                () => SetVector(property, Vector3.right)
            );
            genericMenu.AddItem(
                new GUIContent("Left", "Set the vector to (-1, 0, 0, 0)"),
                (Vector3)vec == Vector3.left,
                () => SetVector(property, Vector3.left)
            );
            genericMenu.AddItem(
                new GUIContent("Up", "Set the vector to (0, 1, 0, 0)"),
                (Vector3)vec == Vector3.up,
                () => SetVector(property, Vector3.up)
            );
            genericMenu.AddItem(
                new GUIContent("Down", "Set the vector to (0, -1, 0, 0)"),
                (Vector3)vec == Vector3.down,
                () => SetVector(property, Vector3.down)
            );
            genericMenu.AddItem(
                new GUIContent("Forward", "Set the vector property to (0, 0, 1, 0)"),
                (Vector3)vec == Vector3.forward,
                () => SetVector(property, Vector3.forward)
            );
            genericMenu.AddItem(
                new GUIContent("Back", "Set the vector property to (0, 0, -1, 0)"),
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                // Slide rect
                {
                    var val = this.ValueEntry.SmartValue;
                    EditorGUI.BeginChangeCheck();
                    var vec = SirenixEditorFields.VectorPrefixSlideRect(
                        labelRect,
            ...
            property.Tree.DelayActionUntilRepaint(() =>
                {
                    ...
                    {
                        property.ValueEntry.WeakValues[i] =
                            math.normalizesafe((float4)property.ValueEntry.WeakValues[i]);
                    }
                }
            );
        }
            ...
            property.Tree.DelayActionUntilRepaint(() =>
                {
                    ...
                    {
                        property.ValueEntry.WeakValues[i] =
                            math.normalizesafe((double2)property.ValueEntry.WeakValues[i]);
                    }
                }
            );
        }
            ...
            property.Tree.DelayActionUntilRepaint(() =>
                {
                    ...
                    {
                        property.ValueEntry.WeakValues[i] =
                            math.normalizesafe((double3)property.ValueEntry.WeakValues[i]);
                    }
                }
            );
        }
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            Rect contentRect = SirenixEditorGUI.BeginHorizontalPropertyLayout(label, out labelRect);
            {
                // Slide rect
                {
                    ...
                    var vec = SirenixEditorFields.VectorPrefixSlideRect(
                        labelRect,
                        new Vector4((float)val.x, (float)val.y, (float)val.z, (float)val.w)
                    );
            ...
            property.Tree.DelayActionUntilRepaint(() =>
                {
                    ...
                    {
                        property.ValueEntry.WeakValues[i] =
                            math.normalizesafe((double4)property.ValueEntry.WeakValues[i]);
                    }
                }
            );
        }
