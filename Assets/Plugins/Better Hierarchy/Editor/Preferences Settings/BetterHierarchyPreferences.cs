        ...
        public static SettingsProvider CreateMyCustomSettingsProvider()
        {
            return new SettingsProvider("Preferences/BetterHierarchy", SettingsScope.User)
            {
                ...
                activateHandler = (searchContext, rootElement) =>
                {
                    ...
                    {
                        var enableToggle = ui.AddToggle(
                            isEnabledBetterHierarchy,
                    ...
                    {
                        var unityScriptsOnlySelection = ui.AddSelection(
                            containsUnityScriptsOnly,
                    ...
                    {
                        var userScriptDetectionTooltip = ui.AddTooltip(
                            "How does user-script detection work",
                        ...
                        var userScriptsSelection = ui.AddSelection(
                            containsNonUnityScripts,
                            "The icon style when there are any user-made scripts inside of a GameObject."
                        );
                        var unityScriptTypeSelection = ui.AddSelection(
                            unityScriptDetectionType,
                    ...
                    {
                        var isAPrefabToggle = ui.AddToggle(
                            isOverridePrefabIconType,
                        ...
                        var isAPrefabSelection = ui.AddSelection(
                            isAPrefab,
                    ...
                    {
                        ui.AddToggle(
                                isEnableTooltipsOnHierarchyObject,
